...
# ======== 路徑（請改成你的模型位置）========
# YOLO_MODEL_PATH = "/home/b310/桌面/fall_backend/yolov8n.pt"  # 原始 Linux 路徑
YOLO_MODEL_PATH = "/home/b310/桌面/TheAged/voice-chat-gemini-master/voice-chat-gemini-dev/app/api/v1/yolov8n.pt"  
# 使用相對路徑，或改成您的實際模型路徑
